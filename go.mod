...
require (
	...
	k8s.io/kube-controller-manager v0.31.4
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/eks v1.57.1 // indirect
	...
	open-cluster-management.io/addon-framework v0.12.0 // indirect
